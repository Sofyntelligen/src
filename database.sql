...
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(1, 'FINALIZADO');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(2, 'REPORTE A RN');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(3, 'TARJETA WINTV ESTREGADA A RN');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(4, 'DISCO DURO ENTREGADO A RN');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(5, 'CPU ENTREGADO A RN');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(6, 'REINICIO');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(7, 'CORRIGEN ANTENA');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(8, 'CONFIGURACION');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(9, 'OTRO');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(10, 'CORRIGEN ENLACE');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(11, 'CONTRASEÑA CORRECTA');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(12, 'CAMBIO TARJETA');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(13, 'CAMBIO DISCO DURO');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(14, 'CAMBIO EQUIPO');
INSERT INTO CAT_ACCIONES(ID, ACCION) VALUES(15, 'REINICIO EQUIPO');
...
INSERT INTO REPORTES_TESTIGOS(ID, ID_TESTIGO, ID_USUARIO, REPORTE, ESTADO) VALUES(1, 1, 1, 1, 1);
...
INSERT INTO COMENTARIOS_REPORTES(ID, ID_USUARIO, REPORTE, COMENTARIO) VALUES(3, 2, 30082017154034, 'OTRO USUARIO');
...
INSERT INTO ACCIONES_REPORTES(ID, ID_USUARIO, REPORTE, ACCION) VALUES(30082017154012, 4, 30082017154034, 11);

DELETE FROM ACCIONES_REPORTES WHERE ID > 0;

DROP TABLE ACCIONES_REPORTES;

CREATE TABLE ACCIONES_REPORTES_TR(
    TIPO_REPORTE NUMBER NOT NULL,
    ACCION NUMBER NOT NULL
);

ALTER TABLE ACCIONES_REPORTES_TR 
ADD CONSTRAINT REPORTES_FK 
FOREIGN KEY(TIPO_REPORTE) REFERENCES CAT_TIPO_REPORTE;

ALTER TABLE ACCIONES_REPORTES_TR 
ADD CONSTRAINT ACCIONES_FK 
FOREIGN KEY(ACCION) REFERENCES CAT_ACCIONES;

INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(2, 6);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(2, 7);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(2, 8);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(2, 9);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(3, 6);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(3, 10);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(3, 8);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(3, 9);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(4, 10);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(4, 11);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(4, 9);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(5, 12);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(5, 13);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(5, 14);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(5, 15);
INSERT INTO ACCIONES_REPORTES_TR(TIPO_REPORTE, ACCION) VALUES(5, 9);

DELETE FROM ACCIONES_REPORTES_TR WHERE ID > 0;

DROP TABLE ACCIONES_REPORTES_TR;



SELECT * FROM CAT_ACCIONES;
...
WHERE
    A.ID = C.TIPO_REPORTE AND B.ID = C.ACCION AND A.ID = 5;
   
   
 
SELECT 
    A.NUMERO_EMPLEADO, A.NOMBRE, B.ID, B.FECHA, B.ID_TESTIGO, C.ID, C.ESTADO, D.ID, E.TIPO_REPORTE, F.SUB_REPORTE
FROM 
    USUARIOS_SOPORTE_CABS A, REPORTES_TESTIGOS B, CAT_ESTADOS C, CAT_REPORTES D, CAT_TIPO_REPORTE E, CAT_SUB_REPORTE F
WHERE
    A.ID = B.ID_USUARIO AND B.ESTADO = C.ID AND B.REPORTE = D.ID AND D.TIPO_REPORTE = E.ID AND D.SUB_REPORTE = F.ID AND B.ID_TESTIGO = 488;



SELECT 
     C.ID AS NUMERO, A.NOMBRE, B.ID, C.FECHA AS FECHA, C.COMENTARIO AS TAREA, 'COMNETARIO' AS TIPO
FROM 
    USUARIOS_SOPORTE_CABS A, REPORTES_TESTIGOS B, COMENTARIOS_REPORTES C
WHERE
    C.ID_USUARIO = A.ID AND C.REPORTE = B.ID AND B.ID = 6092017191237
    UNION ALL(
        SELECT 
        ...
        WHERE
            C.ID_USUARIO = A.ID AND C.REPORTE = B.ID AND C.ACCION = D.ID AND B.ID = 6092017191237)
    ORDER BY NUMERO;
