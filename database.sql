...
CREATE TABLE COMENTARIOS(
    ...
    CONSTRAINT COMENTARIOS_PK PRIMARY KEY (ID) ENABLE 
);
...
INSERT INTO COMENTARIOS(ID, ID_USUARIO, REPORTE, COMENTARIO) VALUES(1, 1, 1, 'PRUEBA');

DELETE FROM COMENTARIOS WHERE ID > 0;
...
CREATE TABLE ACCIONES(
    ...
    CONSTRAINT ACCIONES_PK PRIMARY KEY (ID) ENABLE 
);
...
INSERT INTO ACCIONES(ID, ID_USUARIO, REPORTE, ACCION) VALUES(1, 1, 1, 1);
